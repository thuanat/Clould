...
<head>
	<title>Remote Control | Toy Story</title>
...
<body>
	...
	<div id="logo">
		<a href="fandom.php" style="margin: auto;">

			<img src="res/thinkgeek-grey.png" width="80px" height="50px">
		</a>
	</div>
	...
	<div id="sidebar">
		<ul>
			...
			<li><a href="#cart">
					<table>
						<tr>
							<td><img src="res/icons/cart.png" /></td>
							<td>&nbsp;Shopping Cart</td>
						</tr>
					</table>
				</a></li>
			...
			<li><a href="view_cart.php">
					<table>
						<tr>
							<td><img src="res/icons/checkout.png" /></td>
							<td>&nbsp;Checkout&nbsp;</td>
			...
			<li>
				<a href="destroy.php">
					<table>
						<tr>
							<td><img src="res/icons/logout.png" /></td>
							<td>&nbsp;Logout</td>
						</tr>
					</table>
				</a>
	...
	<div id="navbar">
		<ul>
			<li><a href="got.php">Board Game</a></li>
			<li><a href="hp.php">Lego & Stuffed</a></li>
			<li><a class="active" href="carthg.php">Remote Control</a></li>
		</ul>
	</div>
...
EOT;
	...
	<footer class="container">
		<div class="row">
			<p class="col-sm-6">
				&copy; 2023 Toy Story | Made with<i style="color: #fd4b4b;">&nbsp; &#9829; &nbsp;</i>in Vietnam
